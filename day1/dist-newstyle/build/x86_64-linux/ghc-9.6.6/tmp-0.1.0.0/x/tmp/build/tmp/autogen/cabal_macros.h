...
/* package tmp-0.1.0.0 */
#ifndef VERSION_tmp
#define VERSION_tmp "0.1.0.0"
#endif /* VERSION_tmp */
#ifndef MIN_VERSION_tmp
#define MIN_VERSION_tmp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tmp */
...
#define CURRENT_COMPONENT_ID "tmp-0.1.0.0-inplace-tmp"
